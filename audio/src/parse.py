...
def parse_opt():
    ...
    parser.add_argument('--no-cuda', action='store_true', default=False, help='does not use CUDA')
    ...
    parser.add_argument('--val-split', type=float, default=0.25, help='validation split')
